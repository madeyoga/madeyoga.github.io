...
### 1. Django ORM
One of my favorite things about Django is the ORM. It lets you work with the database without writing raw SQL, and you can also run Python scripts during migrations. This came in handy more than once. Especially when I needed to populate a newly added column with default values right as the migration ran.
...
*Have you been working with Django too? I'd love to hear about it!*
